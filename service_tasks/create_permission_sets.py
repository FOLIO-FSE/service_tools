...
class CreatePermissionSets(ServiceTaskBase):
    ...
    def do_work(self):
        ...
        resp = requests.put(f"{self.folio_client.okapi_url}/perms/permissions/1bf676c0-ac9b-4547-8882-44c5c2a2e6f7", data=json.dumps(circ), headers=self.folio_client.okapi_headers)
        ...
        resp = requests.put(f"{self.folio_client.okapi_url}/perms/permissions/771fcf6f-fa0f-4bb9-ac31-1cb2dfd2b4b8", data=json.dumps(prc), headers=self.folio_client.okapi_headers)
        print(f"{resp.content}")
        ...
        resp = requests.put(f"{self.folio_client.okapi_url}/perms/permissions/3626874b-d383-4c4c-95bf-0252cd15eb24", data=json.dumps(pra), headers=self.folio_client.okapi_headers)
        print(f"{resp.content}")
        ...
        resp = requests.put(f"{self.folio_client.okapi_url}/perms/permissions/02f05a09-60f1-46d3-8e14-930bb8ce81c0", data=json.dumps(erm), headers=self.folio_client.okapi_headers)
        print(f"{resp.content}")
        ...
        resp = requests.put(f"{self.folio_client.okapi_url}/perms/permissions/26b717c6-0d13-4e96-aeda-dfb63c432a29", data=json.dumps(erm_view), headers=self.folio_client.okapi_headers)
        print(f"{resp.content}")
        ...
        resp = requests.put(f"{self.folio_client.okapi_url}/perms/permissions/a53b7dac-13b1-497e-9581-c2144a437ad7", data=json.dumps(erm_admin), headers=self.folio_client.okapi_headers)
        print(f"{resp.content}")
